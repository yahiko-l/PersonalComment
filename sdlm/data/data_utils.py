...
def load_data(data_args, model_args):
    if data_args.dataset_name is not None:
        ...
        raw_datasets = load_dataset(
            ...
            cache_dir=model_args.cache_dir,
            # use_auth_token=True if model_args.use_auth_token else None,   # FutureWarning: 'use_auth_token' was deprecated in favor of 'token' in version 2.14.0 and will be removed in 3.0.0.
            token=None,
            streaming=data_args.streaming
        )
    return raw_datasets
