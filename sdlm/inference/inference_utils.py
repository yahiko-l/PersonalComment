...
from sdlm.metrics_upback.perplexity import perplexity, conditional_perplexity
from sdlm.metrics_upback.metrics import distinct_n_grams, mauve, zipf
from sdlm.metrics_upback.repetition import repetition
...
def sample_logits(sampling_type, logits, top_p, temperature):
    ...
    elif sampling_type in {"argmax", "greedy"}:
