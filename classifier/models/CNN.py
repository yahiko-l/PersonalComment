...
@dataclass
class CNNOutput(ModelOutput):
    loss: Optional[torch.FloatTensor] = None
    logits: torch.FloatTensor = None


class CNN(nn.Module):
	def __init__(self, batch_size, output_size, in_channels, out_channels, kernel_heights, keep_probab, vocab_size, embedding_length, weights):
	...
	def forward(self, input_ids, attention_mask, labels):
		...
		input = self.word_embeddings(input_ids)
